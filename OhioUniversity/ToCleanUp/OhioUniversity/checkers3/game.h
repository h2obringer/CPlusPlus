// File: game.h
//********************************************************
//Randy Obringer: Added two protected bool functions for 
//ease in creating checkers. They are jump_available() and
//jump_again()
//********************************************************
...
class game{
  ...
  protected:
    ...
    //*********I ADDED THESE***********************************************
    virtual bool jump_available()const=0;
    //virtual std::string where_jump_is()=0;
    virtual bool jump_again(const std::string move)const=0;
    //*********************************************************************
    //I moved this to make multiple jumps with computers possible.
    //Originally is not virtual and was private
