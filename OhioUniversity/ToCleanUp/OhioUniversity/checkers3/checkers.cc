    ...
    for(int j=0;j<COLUMNS;j++){
      if(next_mover()==HUMAN){
	    ...
	    return true; //king down and right
          ...
          }else if((i-2>=0)&&(i-2<=7)&&(j+2>=0)&&(j+2<=7)&&((board[i][j]==BLACK_PIECE)||(board[i][j]==BLACK_KING))&&(board[i-1][j+1]==RED_PIECE)&&(board[i-2][j+2]==BLACK_SPACE)){
            return true; //any piece up and right
          }else if((i-2>=0)&&(i-2<=7)&&(j+2>=0)&&(j+2<=7)&&((board[i][j]==BLACK_PIECE)||(board[i][j]==BLACK_KING))&&(board[i-1][j+1]==RED_KING)&&(board[i-2][j+2]==BLACK_SPACE)){
        ...
        if((board[i][j]==RED_PIECE)||(board[i][j]==RED_KING)){ //jump available to red...
          if(new_king){
            return false;
          }else if((i+2>=0)&&(i+2<=7)&&(j+2>=0)&&(j+2<=7)&&((board[i][j]==RED_PIECE)||(board[i][j]==RED_KING))&&(board[i+1][j+1]==BLACK_PIECE)&&(board[i+2][j+2]==BLACK_SPACE)){
	    return true; //any piece down and right
          }else if((i+2>=0)&&(i+2<=7)&&(j+2>=0)&&(j+2<=7)&&((board[i][j]==RED_PIECE)||(board[i][j]==RED_KING))&&(board[i+1][j+1]==BLACK_KING)&&(board[i+2][j+2]==BLACK_SPACE)){
  ...
  if(next_mover()==HUMAN){
    if((board[a][b]==BLACK_PIECE)||(board[a][b]==BLACK_KING)){ //jump available to black...
      if(new_king){
        ...
        return true; //king down and left on a king
      }else if((a-2>=0)&&(a-2<=7)&&(b+2>=0)&&(b+2<=7)&&((board[a][b]==BLACK_PIECE)||(board[a][b]==BLACK_KING))&&(board[a-1][b+1]==RED_PIECE)&&(board[a-2][b+2]==BLACK_SPACE)){
        return true; //any piece up and right
      }else if((a-2>=0)&&(a-2<=7)&&(b+2>=0)&&(b+2<=7)&&((board[a][b]==BLACK_PIECE)||(board[a][b]==BLACK_KING))&&(board[a-1][b+1]==RED_KING)&&(board[a-2][b+2]==BLACK_SPACE)){
        return true; //any piece up and right on a king
      }else if((a-2>=0)&&(a-2<=7)&&(b-2>=0)&&(b-2<=7)&&((board[a][b]==BLACK_PIECE)||(board[a][b]==BLACK_KING))&&(board[a-1][b-1]==RED_PIECE)&&(board[a-2][b-2]==BLACK_SPACE)){
        return true; //any piece up and left
      }else if((a-2>=0)&&(a-2<=7)&&(b-2>=0)&&(b-2<=7)&&((board[a][b]==BLACK_PIECE)||(board[a][b]==BLACK_KING))&&(board[a-1][b-1]==RED_KING)&&(board[a-2][b-2]==BLACK_SPACE)){
...
void checkers::compute_moves(std::queue<std::string>& moves) const{ //for all available board positions push the move on the queue
  std::string move;
  int a,b,newA,newB;
  for(int i=0;i<ROWS;i++){ 
    for(int j=0;j<COLUMNS;j++){
      //ALL REGULAR MOVES FOR REGULAR PIECES AND KINGS
      if(next_mover()==COMPUTER){
        //ALL JUMPS FOR REGULAR PIECES AND KINGS
        if((i+2>=0)&&(i+2<=7)&&(j+2>=0)&&(j+2<=7)&&((board[i][j]==RED_PIECE)||(board[i][j]==RED_KING))&&((board[i+1][j+1]==BLACK_PIECE)||(board[i+1][j+1]==BLACK_KING))&&(board[i+2][j+2]==BLACK_SPACE)){//jump down/right
          a=i; b=j; newA=i+2; newB=j+2; move=char(a+'0'); move+=' '; move+=char(b+'0'); move+=' '; move+=char(newA+'0'); move+=' '; 
          move+=char(newB+'0'); if(is_legal(move)){moves.push(move);} //above sets ints and converts to strings to put in move format 
        }if((i+2>=0)&&(i+2<=7)&&(j-2>=0)&&(j-2<=7)&&((board[i][j]==RED_PIECE)||(board[i][j]==RED_KING))&&((board[i+1][j-1]==BLACK_PIECE)||(board[i+1][j-1]==BLACK_KING))&&(board[i+2][j-2]==BLACK_SPACE)){//jump down/left
          a=i; b=j; newA=i+2; newB=j-2; move=char(a+'0'); move+=' '; move+=char(b+'0'); move+=' '; move+=char(newA+'0'); move+=' '; 
          move+=char(newB+'0'); if(is_legal(move)){moves.push(move);} //above sets ints and converts to strings to put in move format 
        }if((i-2>=0)&&(i-2<=7)&&(j-2>=0)&&(j-2<=7)&&(board[i][j]==RED_KING)&&((board[i-1][j-1]==BLACK_PIECE)||(board[i-1][j-1]==BLACK_KING))&&(board[i-2][j-2]==BLACK_SPACE)){//jump up/left
          a=i; b=j; newA=i-2; newB=j-2; move=char(a+'0'); move+=' '; move+=char(b+'0'); move+=' '; move+=char(newA+'0'); move+=' '; 
          move+=char(newB+'0'); if(is_legal(move)){moves.push(move);} //above sets ints and converts to strings to put in move format 
        }if((i-2>=0)&&(i-2<=7)&&(j+2>=0)&&(j+2<=7)&&(board[i][j]==RED_KING)&&((board[i-1][j+1]==BLACK_PIECE)||(board[i-1][j+1]==BLACK_KING))&&(board[i-2][j+2]==BLACK_SPACE)){//jump up/right
          a=i; b=j; newA=i-2; newB=j-2; move=char(a+'0'); move+=' '; move+=char(b+'0'); move+=' '; move+=char(newA+'0'); move+=' '; 
          move+=char(newB+'0'); if(is_legal(move)){moves.push(move);} //above sets ints and converts to strings to put in move format 
        }if((i+1>=0)&&(i+1<=7)&&(j+1>=0)&&(j+1<=7)&&(!jump_available())&&((board[i][j]==RED_PIECE)||(board[i][j]==RED_KING))&&(board[i+1][j+1]==BLACK_SPACE)){//move down/right
          a=i; b=j; newA=i+1; newB=j+1; move=char(a+'0'); move+=' '; move+=char(b+'0'); move+=' '; move+=char(newA+'0'); move+=' '; 
          move+=char(newB+'0'); if(is_legal(move)){moves.push(move);} //above sets ints and converts to strings to put in move format 
        }if((i+1>=0)&&(i+1<=7)&&(j-1>=0)&&(j-1<=7)&&(!jump_available())&&((board[i][j]==RED_PIECE)||(board[i][j]==RED_KING))&&(board[i+1][j-1]==BLACK_SPACE)){//move down/left
          a=i; b=j; newA=i+1; newB=j-1; move=char(a+'0'); move+=' '; move+=char(b+'0'); move+=' '; move+=char(newA+'0'); move+=' '; 
          move+=char(newB+'0'); moves.push(move); //above sets ints and converts to strings to put in move format 
        }if((i-1>=0)&&(i-1<=7)&&(j-1>=0)&&(j-1<=7)&&(!jump_available())&&(board[i][j]==RED_KING)&&(board[i-1][j-1]==BLACK_SPACE)){//move up/left
          a=i; b=j; newA=i-1; newB=j-1; move=char(a+'0'); move+=' '; move+=char(b+'0'); move+=' '; move+=char(newA+'0'); move+=' '; 
          move+=char(newB+'0'); if(is_legal(move)){moves.push(move);} //above sets ints and converts to strings to put in move format 
        }if((i-1>=0)&&(i-1<=7)&&(j+1>=0)&&(j+1<=7)&&(!jump_available())&&(board[i][j]==RED_KING)&&(board[i-1][j+1]==BLACK_SPACE)){//move up/right
          a=i; b=j; newA=i-1; newB=j+1; move=char(a+'0'); move+=' '; move+=char(b+'0'); move+=' '; move+=char(newA+'0'); move+=' '; 
          move+=char(newB+'0'); if(is_legal(move)){moves.push(move);} //above sets ints and converts to strings to put in move format 
        }
      }
...
//**************************************************************************************
  if(board[a][b]==BLACK_PIECE){ //moving a black piece
    ...
    if((a-1>=0)&&(a-1<=7)&&(b+1>=0)&&(b+1<=7)&&(board[a-1][b+1]==RED_PIECE)&&(a-2==newA)&&(b+2==newB)){//making a jump up and right
      ...
      /*if(jump_again(move)){
        ...
        make_move(move1); 
        if(!jump_available()){return;} //makes sure the player doesn't get extra jumps after multiple jumps.
      }*/
    }else if((a-1>=0)&&(a-1<=7)&&(b+1>=0)&&(b+1<=7)&&(board[a-1][b+1]==RED_KING)&&(a-2==newA)&&(b+2==newB)){//making a jump up and right on a king
      board[a-1][b+1]=BLACK_SPACE;
      red--;
      /*if(jump_again(move)){
        display_status();
    ...
    }else if((a-1>=0)&&(a-1<=7)&&(b-1>=0)&&(b-1<=7)&&(board[a-1][b-1]==RED_PIECE)&&(a-2==newA)&&(b-2==newB)){//making a jump up and left
      board[a-1][b-1]=BLACK_SPACE;
      red--;
      /*if(jump_again(move)){
        display_status();
    ...
    }else if((a-1>=0)&&(a-1<=7)&&(b-1>=0)&&(b-1<=7)&&(board[a-1][b-1]==RED_KING)&&(a-2==newA)&&(b-2==newB)){//making a jump up and left on a king
      board[a-1][b-1]=BLACK_SPACE;
      red--;
      /*if(jump_again(move)){
        display_status();
    ...
    if((newA==0)&&(board[newA][newB]==BLACK_PIECE)){ //change to a black king
      board[newA][newB]=BLACK_KING; game::make_move(move); set_new_king(true); return;
    }
//***************************************************************************************
//MOVING A BLACK KING 
//***************************************************************************************
    ...
    }else if((a+1>=0)&&(a+1<=7)&&(b+1>=0)&&(b+1<=7)&&(board[a+1][b+1]==RED_PIECE)&&(a+2==newA)&&(b+2==newB)){ //making a jump down and right
      board[a+1][b+1]=BLACK_SPACE;
      red--;
      /*if(jump_again(move)){
        display_status();
    ...
    }else if((a+1>=0)&&(a+1<=7)&&(b+1>=0)&&(b+1<=7)&&(board[a+1][b+1]==RED_KING)&&(a+2==newA)&&(b+2==newB)){ //making a jump down and right on a king
      board[a+1][b+1]=BLACK_SPACE;
      red--;
      /*if(jump_again(move)){
        display_status();
    ...
    }else if((a+1>=0)&&(a+1<=7)&&(b-1>=0)&&(b-1<=7)&&(board[a+1][b-1]==RED_PIECE)&&(a+2==newA)&&(b-2==newB)){ //making a jump down and left
      board[a+1][b-1]=BLACK_SPACE;
      red--;
      /*if(jump_again(move)){
        display_status();
    ...
    }else if((a+1>=0)&&(a+1<=7)&&(b-1>=0)&&(b-1<=7)&&(board[a+1][b-1]==RED_KING)&&(a+2==newA)&&(b-2==newB)){ //making a jump down and left on a king
      board[a+1][b-1]=BLACK_SPACE;
      red--;
      /*if(jump_again(move)){
        display_status();
...
//***************************************************************************************
    ...
    if((a+1>=0)&&(a+1<=7)&&(b+1>=0)&&(b+1<=7)&&(board[a+1][b+1]==BLACK_PIECE)&&(a+2==newA)&&(b+2==newB)){//making a jump down and right
      board[a+1][b+1]=BLACK_SPACE;
      black--;
      /*if(jump_again(move)){
        display_status();
    ...
    }else if((a+1>=0)&&(a+1<=7)&&(b+1>=0)&&(b+1<=7)&&(board[a+1][b+1]==BLACK_KING)&&(a+2==newA)&&(b+2==newB)){//making a jump down and right on a king
      board[a+1][b+1]=BLACK_SPACE;
      black--;
      /*if(jump_again(move)){
        display_status();
    ...
    }else if((a+1>=0)&&(a+1<=7)&&(b-1>=0)&&(b-1<=7)&&(board[a+1][b-1]==BLACK_PIECE)&&(a+2==newA)&&(b-2==newB)){//making a jump down and left
      board[a+1][b-1]=BLACK_SPACE;
      black--;
      /*if(jump_again(move)){
        display_status();
    ...
    }else if((a+1>=0)&&(a+1<=7)&&(b-1>=0)&&(b-1<=7)&&(board[a+1][b-1]==BLACK_KING)&&(a+2==newA)&&(b-2==newB)){//making a jump down and left on a king
      board[a+1][b-1]=BLACK_SPACE;
      black--;
      /*if(jump_again(move)){
        display_status();
    ...
    if((newA==7)&&(board[newA][newB]==RED_PIECE)){ //change to a red king
      board[newA][newB]=RED_KING; game::make_move(move); set_new_king(true); return; 
    }
//***************************************************************************************
//MOVING A RED KING 
//***************************************************************************************
    ...
    if((a-1>=0)&&(a-1<=7)&&(b+1>=0)&&(b+1<=7)&&(board[a-1][b+1]==BLACK_PIECE)&&(a-2==newA)&&(b+2==newB)){//making a jump up and right
      board[a-1][b+1]=BLACK_SPACE;
    ...
    }else if((a-1>=0)&&(a-1<=7)&&(b+1>=0)&&(b+1<=7)&&(board[a-1][b+1]==BLACK_KING)&&(a-2==newA)&&(b+2==newB)){//making a jump up and right on a king
      board[a-1][b+1]=BLACK_SPACE;
      black--;
      /*if(jump_again(move)){
        display_status();
    ...
    }else if((a-1>=0)&&(a-1<=7)&&(b-1>=0)&&(b-1<=7)&&(board[a-1][b-1]==BLACK_PIECE)&&(a-2==newA)&&(b-2==newB)){//making a jump up and left
      board[a-1][b-1]=BLACK_SPACE;
      black--;
      /*if(jump_again(move)){
        display_status();
    ...
    }else if((a-1>=0)&&(a-1<=7)&&(b-1>=0)&&(b-1<=7)&&(board[a-1][b-1]==BLACK_KING)&&(a-2==newA)&&(b-2==newB)){//making a jump up and left on a king
      board[a-1][b-1]=BLACK_SPACE;
      black--;
      /*if(jump_again(move)){
        display_status();
    ...
    }else if((a+1>=0)&&(a+1<=7)&&(b+1>=0)&&(b+1<=7)&&(board[a+1][b+1]==BLACK_PIECE)&&(a+2==newA)&&(b+2==newB)){ //making a jump down and right
      board[a+1][b+1]=BLACK_SPACE;
      black--;
      /*if(jump_again(move)){
        display_status();
...
int checkers::evaluate() const{ //returns positive numbers for good computer moves and negative for bad
  int black_points,red_points,total_points;
  for(int i=0;i<ROWS;i++){
    for(int j=0;j<COLUMNS;j++){
      if(board[i][j]==RED_PIECE) red_points++;
      if(board[i][j]==RED_KING) red_points+=2;
      if(board[i][j]==BLACK_PIECE) black_points++;
      if(board[i][j]==BLACK_KING) black_points+=2;
      if(black_points>=red_points){
        total_points=red_points-(black_points+1); //add one incase red points equals black points.
        return total_points;
      }else if(black_points<red_points){
        total_points=red_points+(12-black_points); //the less black pieces the more points which is a better move...
      }
    }
  }
}
...
bool checkers::is_legal(const string& move)const{
  ...
  //*******************************************************************************
    if(board[a][b]==BLACK_PIECE){ //if moving a BLACK PIECE
      ...
      }else if((a-2>=0)&&(a-2<=7)&&(b+2>=0)&&(b+2<=7)&&(board[a-1][b+1]==RED_PIECE)&&(a-2==newA)&&(b+2==newB)){ //making a jump up and right
        return true;
      }else if((a-2>=0)&&(a-2<=7)&&(b+2>=0)&&(b+2<=7)&&(board[a-1][b+1]==RED_KING)&&(a-2==newA)&&(b+2==newB)){ //making a jump up and right on a king
        return true;
      }else if((a-2>=0)&&(a-2<=7)&&(b-2>=0)&&(b-2<=7)&&(board[a-1][b-1]==RED_PIECE)&&(a-2==newA)&&(b-2==newB)){ //making a jump up and left
        return true;
      }else if((a-2>=0)&&(a-2<=7)&&(b-2>=0)&&(b-2<=7)&&(board[a-1][b-1]==RED_KING)&&(a-2==newA)&&(b-2==newB)){ //making a jump up and right on a king
        return true;
      }else if(jump_available()){ //if a jump is available then these moves cannot be made
        if((a-1>=0)&&(b+1<=7)&&(newA==a-1)&&(newB==b+1)){ //if move is up and right (good)
          return false;
        }else if((a-1>=0)&&(b-1>=0)&&(newA==a-1)&&(newB==b-1)){ //if move is up and left (good)
          return false;
        }
  ...
  //*******************************************************************************
      ...
      if((board[newA][newB]==BLACK_PIECE)||(board[newA][newB]==BLACK_KING)||(board[newA][newB]==RED_KING)||(board[newA][newB]==RED_PIECE)){ 
        return false;//if space is occupied (no good)
      }else if((a-2>=0)&&(b+2<=7)&&(board[a-1][b+1]==RED_PIECE)&&(a-2==newA)&&(b+2==newB)){//making a jump up and right
        return true;
      }else if((a-2>=0)&&(b+2<=7)&&(board[a-1][b+1]==RED_KING)&&(a-2==newA)&&(b+2==newB)){//making a jump up and right on a king
        return true;
      }else if((a-2>=0)&&(b-2>=0)&&(board[a-1][b-1]==RED_PIECE)&&(a-2==newA)&&(b-2==newB)){//making a jump up and left
        return true;
      }else if((a-2>=0)&&(b-2>=0)&&(board[a-1][b-1]==RED_KING)&&(a-2==newA)&&(b-2==newB)){//making a jump up and left on a king
        return true;
      }else if((a+2<=7)&&(b+2<=7)&&(board[a+1][b+1]==RED_PIECE)&&(a+2==newA)&&(b+2==newB)){ //making a jump down and right
        return true;
      }else if((a+2<=7)&&(b+2<=7)&&(board[a+1][b+1]==RED_KING)&&(a+2==newA)&&(b+2==newB)){ //making a jump down and right on a king
        return true;
      }else if((a+2<=7)&&(b-2>=0)&&(board[a+1][b-1]==RED_PIECE)&&(a+2==newA)&&(b-2==newB)){ //making a jump down and left
        return true;
      }else if((a+2<=7)&&(b-2>=0)&&(board[a+1][b-1]==RED_KING)&&(a+2==newA)&&(b-2==newB)){ //making a jump down and left on a king
        return true;
      }else if(jump_available()){ //if jump available these moves cannot be made
        if((a-1>=0)&&(b-1>=0)&&(newA==a-1)&&(newB==b-1)){ //if move is up and left (good)
          return false;
        }else if((a-1>=0)&&(b+1<=7)&&(newA==a-1)&&(newB==b+1)){ //if move is up and right (good)
          return false;
        }else if((a+1<=7)&&(b+1<=7)&&(newA==a+1)&&(newB==b+1)){ //if move is down and right (good)
          return false;
        }else if((a+1<=7)&&(b-1>=0)&&(newA==a+1)&&(newB==b-1)){ //if move is down and left (good)
          return false;
        }
  ...
  //*******************************************************************************   
    if(board[a][b]==RED_PIECE){ //if moving a red piece
      if((board[newA][newB]==BLACK_PIECE)||(board[newA][newB]==BLACK_KING)||(board[newA][newB]==RED_KING)||(board[newA][newB]==RED_PIECE)){ 
        return false;//if space is occupied (no good)
      }else if((a+2<=7)&&(b+2<=7)&&(board[a+1][b+1]==BLACK_PIECE)&&(a+2==newA)&&(b+2==newB)){//making a jump down and right 
        return true;
      }else if((a+2<=7)&&(b+2<=7)&&(board[a+1][b+1]==BLACK_KING)&&(a+2==newA)&&(b+2==newB)){//making a jump down and right on a king
        return true;
      }else if((a+2<=7)&&(b-2>=0)&&(board[a+1][b-1]==BLACK_PIECE)&&(a+2==newA)&&(b-2==newB)){//making a jump down and left
        return true;
      }else if((a+2<=7)&&(b-2>=0)&&(board[a+1][b-1]==BLACK_KING)&&(a+2==newA)&&(b-2==newB)){//making a jump down and left on a king
        return true;
      }else if(jump_available()){ //if jump available these moves cannot be made
        if((a+1<=7)&&(b+1<=7)&&(newA==a+1)&&(newB==b+1)){ //if move is down and right (good)
          return false;
        }else if((a+1<=7)&&(b-1>=0)&&(newA==a+1)&&(newB==b-1)){ //if move is down and left (good)
          return false;
        }
  ...
  //*******************************************************************************
      ...
      if((board[newA][newB]==BLACK_PIECE)||(board[newA][newB]==BLACK_KING)||(board[newA][newB]==RED_KING)||(board[newA][newB]==RED_PIECE)){ 
        return false;//if space is occupied (no good)
      }else if((a-2>=0)&&(b+2<=7)&&(board[a-1][b+1]==BLACK_PIECE)&&(a-2==newA)&&(b+2==newB)){//making a jump up and right
        return true;
      }else if((a-2>=0)&&(b+2<=7)&&(board[a-1][b+1]==BLACK_KING)&&(a-2==newA)&&(b+2==newB)){//making a jump up and right on a king
        return true;
      }else if((a-2>=0)&&(b-2>=0)&&(board[a-1][b-1]==BLACK_PIECE)&&(a-2==newA)&&(b-2==newB)){//making a jump up and left
        return true;
      }else if((a-2>=0)&&(b-2>=0)&&(board[a-1][b-1]==BLACK_KING)&&(a-2==newA)&&(b-2==newB)){//making a jump up and left on a king
        return true;
      }else if((a+2<=7)&&(b+2<=7)&&(board[a+1][b+1]==BLACK_PIECE)&&(a+2==newA)&&(b+2==newB)){ //making a jump down and right
        return true;
      }else if((a+2<=7)&&(b+2<=7)&&(board[a+1][b+1]==BLACK_KING)&&(a+2==newA)&&(b+2==newB)){ //making a jump down and right on a king
...
bool checkers::is_game_over() const{ //check to see if the game is over or not
  int red_possibilities=black_possibilities=0;
  for(int i=0;i<ROWS;i++){
    for(int j=0;j<COLUMNS;j++){
  ...
  }if((red_possibilities==0)||(black_possibilities==0)){
    return true;
