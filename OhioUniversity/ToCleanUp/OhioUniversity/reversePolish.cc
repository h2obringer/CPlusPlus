...
//  
//  Parameters: 
//    s: a stack of symbol strings holding only "+","-","*", or "/" (passed by reference)
//    n: a stack of number strings that only holds numbers (passed by reference)
//
