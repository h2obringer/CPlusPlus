...
//
// Known Bugs: Through the limited time of testing I have found no known errors. 
//   However, broadcast and multicast has not yet been implemented. Please refer
//   to the readme file if you have not done so.
//
// Note: multicast and broadcast are supported through the means that no specific machine 
//   can possibly be assigned the specific IP addresses that identify a packet to be broadcast
//   or multicast. With this in mind nothing special needs to be done with the address checking
//   to see if it needs forwarded everywhere because of a broadcast or multicast destination address.
//   Logic behind this: the router will never see a source address coming from a request for multicast
//   or broadcast and because of this fact, the packet will be sent everywhere anyways.
//
//***************************************************
