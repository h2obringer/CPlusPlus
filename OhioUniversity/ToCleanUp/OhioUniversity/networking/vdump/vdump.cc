...
//
// Known Bugs: the defaults for the interface and group number seem to be the only things
//   that give results in my program. Probably because I don't know how to use 
//   vr_pickup though...
//
//***************************************************
