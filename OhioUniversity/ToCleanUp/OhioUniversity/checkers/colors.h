...
//Description: Addition to Matthew's code for use in checkers
const string RED_PIECE=B_BLACK+RED+" O "; //red piece
const string BLACK_PIECE=B_BLACK+WHITE+" O "; //black piece
