...
//    It also incorporates sound (sound only works on Linux OSs). Loading and saving capabilities are 
...
//    the Rubik's Cube as easily as possible. Project timeline was one week.
//
