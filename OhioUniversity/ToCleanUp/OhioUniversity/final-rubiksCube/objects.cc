...
//constructor - Middle Middle Front
MMF::MMF(){
	x_axis=ZERO;
	y_axis=ZERO;
	z_axis=ZERO;
...
//constructor - Middle Middle Middle
MMM::MMM(){
	x_axis=ZERO;
	y_axis=ZERO;
	z_axis=ZERO;
...
//constructor - Middle Middle Back
MMB::MMB(){
	x_axis=ZERO;
	y_axis=ZERO;
	z_axis=ZERO;
...
//constructor - Middle Right Front
MRF::MRF(){
	x_axis=ZERO;
	y_axis=ZERO;
	z_axis=ZERO;
...
//constructor - Middle Right Middle
MRM::MRM(){
	x_axis=ZERO;
	y_axis=ZERO;
	z_axis=ZERO;
...
//constructor 0 Down Left Middle
DLM::DLM(){
	x_axis=ZERO;
	y_axis=ZERO;
	z_axis=ZERO;
...
//constructor - Down Middle Middle
DMM::DMM(){
	x_axis=ZERO;
	y_axis=ZERO;
	z_axis=ZERO;
