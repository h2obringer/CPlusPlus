...
//Purpose: This is the implementation of all the functions needed to manipulate a student's
//records. It is all given in menu format for easier navigation by the user. Makes sure that
//the save and load functions are incorporated correctly.
//
//Project 5
//*****************************************************************************************
